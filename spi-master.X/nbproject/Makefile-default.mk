...
FINAL_IMAGE=${DISTDIR}/PIC16F_SPI.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/PIC16F_SPI.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
